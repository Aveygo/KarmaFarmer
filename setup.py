...
setup(
  ...
  description = 'Joins and participates in r/KarmaStreet to upvote other users thus inf. karma',   # Give a short description about your library
  ...
  download_url = 'https://github.com/CodingCoda/KarmaFarmer/archive/refs/tags/v0.1-alpha.tar.gz',    # I explain this later on
